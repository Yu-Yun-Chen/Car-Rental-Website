...
<head>
    ...
    <style>
        body {
            ...
            background: url('https://images.unsplash.com/photo-1522093007474-d86e9bf7ba6f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxMTc3M3wwfDF8c2VhcmNofDEyfHxwYWxhaXMlMjByb3lhbCUyMHBhcmlzfGVufDB8fHx8MTYxNTQ3MzQxNA&ixlib=rb-1.2.1&q=80&w=2000') no-repeat center center fixed;
        ...
        input[type="submit"]:hover {
            background-color: rgba(80,120,100,0.7);
        }
        .note {
            font-size: 12px;
            color: #666;
...
<body>
    <div class="container">
        <h2>註冊帳號</h2>
        <form name="form" method="post" action="register_finish_u.php">            
            ...
            <br>
            <label for="license">License Upload:</label>  <input type="file" name="license" id="license" accept="image/*" required>
            <br><br>
